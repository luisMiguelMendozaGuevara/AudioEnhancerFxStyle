...
TRANSLATIONS = {
    ...
    "Se perdió el dispositivo de %s. Revisa el ruteo.": "Lost the %s device. Check the routing.",
    "Se perdió el dispositivo de %s.": "Lost the %s device.",
    "captura": "capture",
    "salida": "output",
    "Salida Bluetooth: usa 100 ms si oyes cortes.": "Bluetooth: use 100 ms if you hear dropouts.",
    "DIAGNÓSTICO": "DIAGNOSTICS",
    "Exportar diagnóstico": "Export diagnostics",
    "Diagnóstico guardado en %s": "Diagnostics saved to %s",
    "No se pudo guardar el diagnóstico.": "Could not save the diagnostics.",
